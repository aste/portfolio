  ...
  projects: [
    {
      ...
      bullets: ["Built a responsive frontend using JavaScript, HTML, CSS, and Bootstrap, integrating external APIs and deploying via Netlify with automated CI/CD.", "Implemented custom booking and contact flows and a simple news section designed for non-technical content updates.", "Increased site traffic and user engagement by 400% after launch."],
